	...
	<div id="wrapper">
						...
						<ul class="nav navbar-nav navbar-right pull-right">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="{{ route('profile.edit') }}"><i class="md md-face-unlock"></i>
											{{ __('Profile') }}</a>
									</li>
									<li>
										<form method="POST" action="{{ route('logout') }}">
											...
											<a href="route('logout')" style="
												...
												onclick="event.preventDefault(); this.closest('form').submit();"><i
													class="md md-settings-power text-danger"></i>
												{{ __('Log Out') }}</a>
										</form>
									</li>
								</ul>
		...
		<div class="content-page" style="min-height: 100dvh">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb pull-right" style="text-transform: uppercase">
								<li>
									<a href="{{ URL::to('/dashboard') }}">Genie</a>
								</li>
								<li>
			...
			<footer class="footer text-right">
				©
				<?php echo date('Y')?>
				Developed By Abu Salah Musha Lemon
			</footer>
		</div>
		<!-- ============================================================== -->
