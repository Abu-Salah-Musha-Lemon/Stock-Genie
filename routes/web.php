...
//     Route::get('/dashboard', [DashboardController::class, 'index'])->name('admin.dashboard'); // Updated
// });
// Route::middleware('roleManager:employee')->group(function () {
//     Route::get('/dashboard', [DashboardController::class, 'index'])->name('employee.dashboard'); // Updated
// });
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/edit-employee/{id}', [singleEmployeeController::class, 'edit']);
    Route::patch('/employees/{id}', [SingleEmployeeController::class, 'update'])->name('update');
    Route::middleware('roleManager:admin')->group(function () {
        // Admin specific routes
        Route::get('/dashboard/admin', [DashboardController::class, 'index'])->name('admin.dashboard'); // Admin dashboard
