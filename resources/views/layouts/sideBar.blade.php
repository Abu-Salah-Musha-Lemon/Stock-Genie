...
<div id="sidebar-menu">
    <ul>
        ...
        <!-- POS Section (Accessible for both Admin and Employee) -->
        ...
        <!-- Order Section (Accessible for both Admin and Employee) -->
        ...
        <!-- Product and Category Management (Only for Admin) -->
        @if(auth()->user()->role === 0)
        ...
        <!-- Supplier Management (Only for Admin) -->
        @if(auth()->user()->role === 0)
        ...
        <!-- Expense Management (Only for Admin) -->
        @if(auth()->user()->role === 0)
